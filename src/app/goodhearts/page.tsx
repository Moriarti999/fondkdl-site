    ...
    <main className="min-h-screen bg-white text-gray-800">
      <FadeIn>
        <section className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 text-white py-20 px-4 text-center">
          ...
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6">«Добрые сердца» 🧡</h1>
          <p className="text-lg md:text-xl opacity-95 mb-8 max-w-3xl mx-auto leading-relaxed">Программа направлена на оказание материальной помощи детям из малообеспеченных семей и детям со сложными заболеваниями.</p>
      ...
      <FadeIn>
        <section className="py-20 px-4 bg-gradient-to-br from-orange-600 to-orange-800 text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl opacity-95 mb-10">Каждое пожертвование — это шанс на лечение и здоровое детство</p>
            <button onClick={() => setHelpModal(true)} className="px-10 py-5 bg-white text-orange-700 rounded-2xl font-bold text-xl hover:bg-yellow-50 hover:scale-105 transition-all shadow-2xl">Сделать пожертвование 🧡</button>
