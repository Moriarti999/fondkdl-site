    ...
    <main className="min-h-screen bg-white text-gray-800">
      <FadeIn>
        <section className="bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 text-white py-20 px-4 text-center">
          ...
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Центр реабилитации <span className="text-yellow-300">"ЧАЙКА"</span> 🕊️</h1>
          <p className="text-lg md:text-xl opacity-95 mb-8 max-w-3xl mx-auto leading-relaxed">Для детей с ДЦП, РАС и ЗПР из малообеспеченных и многодетных семей. <br />Интенсивная реабилитация и социальная адаптация, не выезжая за пределы региона.</p>
          <button onClick={() => setHelpModal(true)} className="px-8 py-4 bg-white text-orange-700 rounded-xl font-bold text-lg hover:bg-yellow-50 hover:scale-105 transition-all shadow-xl">Поддержать проект ❤️</button>
        </section>
      </FadeIn>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-orange-50 rounded-2xl p-8 border-l-4 border-orange-500 shadow-sm">
              <p className="text-gray-700 leading-relaxed text-lg">Проект направлен на развитие системной и комплексной помощи детям с особенностями развития из малообеспеченных и многодетных семей...</p>
              <p className="text-gray-700 leading-relaxed text-lg mt-4">Расходы на оплату приезжих специалистов покрываются за счет орг. взносов тех, кто имеет возможность самостоятельно оплатить курс реабилитации.</p>
            </div>
          </div>
        </section>
      </FadeIn>
      ...
      <FadeIn>
        <section className="py-20 px-4 bg-gradient-to-br from-orange-600 to-orange-800 text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl opacity-95 mb-10">Ваше пожертвование оплачивает курсы реабилитации, работу специалистов и поддержку семей</p>
            <button onClick={() => setHelpModal(true)} className="px-10 py-5 bg-white text-orange-700 rounded-2xl font-bold text-xl hover:bg-yellow-50 hover:scale-105 transition-all shadow-2xl">Сделать пожертвование 🕊️</button>
